...
<script>
  ...
  import { requestVerifyStaffPhone, requestVerifyStaffEmail } from "../../backend/api"
  ...
  export default {
    ...
    methods: {
      ...
      verifyPhone: function () {
        requestVerifyStaffPhone(this.credentials.phone).then((response) => {
      ...
      verifyEmail: function () {
        requestVerifyStaffEmail(this.credentials.email).then((response) => {
          if (response.data.message === "Already exist!") {
